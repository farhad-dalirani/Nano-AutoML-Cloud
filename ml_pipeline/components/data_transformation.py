    ...
    def get_data_transformer_object(self) -> ColumnTransformer:
        ...
        try:
            ...
            numerical_columns = [
                ...
                if col not in ignore_columns and col != target_column
            ]
            categorical_columns = [
                col
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            input_feature_train_df = train_df.drop(
                columns=[self.training_pipeline_config.target_column], axis=1
            )
            target_feature_train_df = train_df[
                self.training_pipeline_config.target_column
            ]
            ...
            if schema.get("DATA_TRANSFORMATION_ENABLE_TARGET_CLASS_MAPPING", False):
                ...
                logging.info(
                    "Trainset Target class values were remaped: {}".format(mapping)
                )
            ...
            if schema.get("DATA_TRANSFORMATION_ENABLE_TARGET_CLASS_MAPPING", False):
                ...
                logging.info(
                    "Test Target class values were remaped: {}".format(mapping)
                )
